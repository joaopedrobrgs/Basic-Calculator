window.onload = function () {
    ...
    function zeroFunction() {
        if (recentNumber == "NaN" || otherNumbers.innerText == "NaN") {
    ...
    function additionFunction() {
        if (operator.innerText == "+") {
            otherNumbers.innerText = parseFloat(otherNumbers.innerText) + parseFloat(recentNumber.innerText);
        ...
        if (operator.innerText == "pow") {
            otherNumbers.innerText = Math.pow(parseFloat(otherNumbers.innerText), parseFloat(recentNumber.innerText));
            recentNumber.innerText = " ";
            operator.innerText = "+"
        }
        else {
